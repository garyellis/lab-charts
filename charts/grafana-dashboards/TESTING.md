...
Acceptance requires exactly two ConfigMaps, group-qualified names, discovery
...
ConfigMaps in `observability`, Grafana lists both stable UIDs under
`OpenStack · ai1`, and a Grafana restart restores both dashboards from Git.
